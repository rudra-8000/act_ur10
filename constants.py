...
DT = 0.033  # 50Hz control; adjust if your lerobot fps differs

# UR10 has 6 joints. With PincOpen gripper (single DOF) = 7D total.
# Verify this matches your actual qpos/action dimension from the parquet.
STATE_DIM = 7